    ...
    public class ArtifactPoolEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Duplicate"))
            {
                ...
                newPool.untargetedT = orginal.untargetedT.DeepClone();
                newPool.untargetedE = orginal.untargetedE.DeepClone();
                newPool.targetedT = orginal.targetedT.DeepClone();
                newPool.targetedE = orginal.targetedE.DeepClone();
